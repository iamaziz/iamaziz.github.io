...
- [Maqam Oud](https://iamaziz.github.io/maqam_oud): An interactive Oud neck visualizer to explore Arabic Maqam scales with sound playback and a built-in Sequence Builder for composing, editing, and playing back custom note sequences.
...
- [FretLab](https://iamaziz.github.io/FretLab.html): an interactive, browser-based guitar studio that allows users to visualize complex chord voicings, audition realistic audio, and arrange custom progressions through an intuitive drag-and-drop sequencer.